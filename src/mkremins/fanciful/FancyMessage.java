...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	 ...
	 * @return This builder instance.
	 * @throws IllegalArgumentException If the specified {@code ChatColor} enumeration value is not a color (but a formatLong value).
	 */
...
//		map.put("JSON", toJSONString());
	...
	/**
	 * Deserializes a fancy message from its JSON representation. This JSON representation is of the formatLong of
	...
	public static FancyMessage deserialize(String json) {
		...
		for (JsonElement mPrt : extra) {
			...
			for (Map.Entry<String, JsonElement> entry : messagePart.entrySet()) {
				...
				} else if (entry.getKey().equals("runCommands")) {
