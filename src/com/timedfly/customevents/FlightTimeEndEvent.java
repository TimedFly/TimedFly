...
public class FlightTimeEndEvent extends Event {
    ...
    public FlightTimeEndEvent(Player player, UUID uuid, int initialTime, int timeLeft, boolean timePaused, PlayerManager playerManager) {
        this.player = player;
        this.uuid = uuid;
