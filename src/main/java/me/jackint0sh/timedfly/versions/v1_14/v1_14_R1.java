package me.jackint0sh.timedfly.versions.v1_14;
...
public class v1_14_R1 extends ServerVersion {
    ...
    public void sendTitle(Player player, String title, String subtile, int fadeIn, int stay, int fadeOut) {
        ...
        IChatBaseComponent chatSubTitle = ChatSerializer.a("{\"text\": \"" + subtile + "\",\"color\":\"white\"}");
